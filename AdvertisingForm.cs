...
namespace WindowsFormsApplication4
{
    public partial class AdvertisingForm : Form
    {
        ...
        {
            if(
            checkBox_agree.Checked == true &&
            checkBox_agree2.Checked == true)
            {
                MySqlCommand cmd = new MySqlCommand(
                    "INSERT INTO Advertisment(Text, Pic, Date_From, Data_to, id, new)", SQLClass.CONN);
            ...
            //VALUES ('" + text_na_reklame.Text + "', '', '13.10.2018', '20.10.2018', '6', '1');
        }
